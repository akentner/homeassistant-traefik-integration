"""Button platform for the Traefik integration.

Phase 2 plan 02-03 fills this out with `TraefikReloadButton` on the Diagnostics
device (D-13). For now this module is a forward-reference stub so
...
async def async_setup_entry(
    ...
    """Set up Traefik button entities (filled out in plan 02-03)."""
    return None